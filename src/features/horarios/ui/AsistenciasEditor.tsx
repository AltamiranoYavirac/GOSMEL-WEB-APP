...
import type { IAsistenciasEditorProps } from "./AsistenciasEditor.types";

const ESTADO_ASISTENCIA_OPCIONES: {
...
export default function AsistenciasEditor({ data, mutation, onSaved }: IAsistenciasEditorProps) {
