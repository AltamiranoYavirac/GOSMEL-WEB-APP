  ...
  return (
    <div className="flex h-full flex-col justify-between gap-4 rounded-2xl border border-border bg-card p-5 sm:p-6">
      <div className="flex w-full items-center justify-between gap-2">
        <h3 className="font-heading text-[0.969rem] font-bold tracking-tight text-foreground">{title}</h3>
        {viewAllHref ? (
          <Link
            href={viewAllHref}
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="mt-0.5 flex items-center gap-1.5">
                      ...
                      <span className="truncate text-[0.719rem] text-muted-foreground">{item.subtitle}</span>
                    </span>
                  </span>
                  <span className="shrink-0 text-[0.625rem] font-mono font-semibold text-muted-foreground">{item.meta}</span>
                </Link>
