...
export default function CoursesList({ teachersByCourse }: ICoursesListProps) {
  return (
    <section className="bg-warm-50 pb-[70px] pt-[52px] md:pb-[110px] md:pt-[70px]">
      <div className="mx-auto w-full max-w-[1600px] px-[22px] md:px-14">
        <Reveal as="p" className="mb-3 font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-primary-700 md:text-[11px] md:tracking-[0.22em]">
          Siete disciplinas · una academia
        </Reveal>
        <Reveal as="h2" delay={0.08} className="mb-[34px] max-w-[720px] text-[31px] font-semibold tracking-[-0.035em] text-foreground md:mb-12 md:text-[44px]">
