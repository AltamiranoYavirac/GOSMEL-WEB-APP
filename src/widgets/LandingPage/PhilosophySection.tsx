  ...
  return (
    <section className="bg-background px-[22px] pb-[66px] pt-[76px] text-foreground md:px-14 md:pb-[110px] md:pt-[130px]">
      <div className="mx-auto max-w-[1600px] text-left md:text-center">
        <h2 className="landing-rise mx-auto max-w-[900px] text-[33px] font-semibold leading-[1.12] tracking-[-0.035em] md:text-[58px] md:leading-[1.1]">
        ...
        <dl className="landing-rise mx-auto mt-[46px] grid max-w-[1100px] grid-cols-2 md:mt-20 md:grid-cols-4 [&>div:nth-child(even)]:border-l [&>div:nth-child(n+3)]:border-t md:[&>div:nth-child(n+3)]:border-t-0 md:[&>div+div]:border-l">
