  ...
  return (
    ...
    >
      <Image
        ...
        fetchPriority="high"
        sizes="100vw"
        className="landing-zoom-out object-cover object-center md:hidden"
      />
      <Image
        ...
        fetchPriority="high"
        sizes="100vw"
        className="landing-zoom-out hidden object-cover object-center md:block"
      />
      ...
      <div className="absolute inset-x-0 bottom-0 z-10 mx-auto w-full max-w-[1600px] px-[22px] pb-8 text-surface-dark-foreground md:px-14 md:pb-[62px]">
        <p className="mb-4 font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-stage-accent md:mb-[22px] md:text-[11px] md:tracking-[0.24em]">
        ...
        <p className="mt-4 max-w-[560px] text-base leading-[1.55] text-surface-dark-muted md:mt-6 md:text-[19px]">
        ...
        <div className="mt-[26px] flex flex-col gap-2.5 md:mt-[34px] md:flex-row md:items-center md:gap-[30px]">
          <Button
            asChild
